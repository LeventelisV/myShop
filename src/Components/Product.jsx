...
export default function Product({ product }) {
    ...
    return (
        <article className="md:flex items-center mt-14 py-8 border-t border-gray-200">
            <div className="w-1/4">
                <img alt="product" src={product.image} className="w-full h-full object-center object-cover" />
            </div>
            <div className="md:pl-3 md:w-3/4">
                ...
                <div className="flex items-center justify-end pt-5 pr-6">
                    <div className="flex items-center">
                        ...
                        <input type="button" className="text-xs  leading-3 underline text-red-500 pl-5 pr-5 cursor-pointer"
                            onClick={removeFromBasket} value="Remove from the basket"/> 
                    </div>
